...
class PDF extends FPDF
{
    ...
    function Header()
    {
    	...
    	// $this->Cell(60);
    	// Title
        $this->Cell(308,8,'PEMERINTAH KABUPATEN BIAK NUMFOR',0,1,'C');
        $this->Cell(308,8,'DISTRIK SAMOFA',0,1,'C');
...
$nomor = 1;
    ...
    $pdf->cell(45,7,'Istri/Anak',0,0,'L');
    $pdf->cell(2,7,':',0,0,'L');
    $pdf->cell(26, 7, strtoupper($data_warga[0]['status_keluarga']), 0, 1, 'L');
